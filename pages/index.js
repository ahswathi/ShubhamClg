                 ...
                 <section className="section-box">
                    <div className="banner-hero banner-2 bg-about-1">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-7">
                                    <h1 className="text-display-3">Building strong foundations, nurturing academic success !</h1>
                                    <div className="mt-40">
                                ...
                                <div className="col-lg-5 d-none d-lg-block">
                                    <div className="banner-imgs">
                                        ...
                                        <img className="img-responsive shape-2" alt="Agon" src="assets/image-01.png" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container mt-100">
                        <div className="row">
                            <div className="col-lg-6 col-sm-12 block-img-we-do">
                                <img className="bdrd-16 img-responsive " src="assets/home.jpg" alt="Agon" height='600px' />
                            </div>
                            <div className="col-lg-6 col-sm-12 block-we-do">
                                <span className="tag-1">About us</span>
                                <h3 className="text-heading-1 mt-30">
                                WELCOME TO SHUBHAM DEGREE COLLEGE
                                </h3>
                                <p className="text-body-lead-large color-gray-600 mt-30">
                                We are committed to providing a comprehensive and high-quality education to our students, 
                                equipping them with the skills and knowledge necessary for success in their chosen fields.
                                </p>
                                ...
                                <div className="row">
                                    <div className="col-lg-6 col-sm-6 col-12 mt-50">
                                        ...
                                        Our mission is to foster a stimulating learning environment that promotes academic excellence,
                                         personal growth, and the development of well-rounded individuals.
                                        </p>
                                    </div>
                                    <div className="col-lg-6 col-sm-6 col-12 mt-50">
                                        <h4 className="text-heading-6 icon-leaf">
                                        ...
                                        <p className="text-body-excerpt color-gray-600 mt-15">
                                        We offer a diverse range of undergraduate degree programs across various disciplines, 
                                        ensuring that students have the opportunity to pursue their passions and interests.
                                        </p>
                                    </div>
                                    <div className="col-lg-6 col-sm-6 col-12 mt-50">
                                        <h4 className="text-heading-6 icon-leaf">
                                        ...
                                        <p className="text-body-excerpt color-gray-600 mt-15">
                                        Our college boasts a highly qualified and dedicated faculty who are experts in their respective fields.
                                        </p>
                                    </div>
                                    <div className="col-lg-6 col-sm-6 col-12 mt-50">
                                        <h4 className="text-heading-6 icon-leaf">
                                        ...
                                        <p className="text-body-excerpt color-gray-600 mt-15">
                                        We understand the importance of providing students with a conducive environment for learning.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8 col-sm-10 col-12 text-center">
                                <h2 className="text-heading-1 color-gray-900">Courses we offer
{/* <br className="d-lg-block d-none" />ideas to life */}</h2>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-sm-12">
                                <div className="card-grid-style-3 pb-40 bg-5 mb-30">
                                    ...
                                    <h3 className="text-heading-3 mt-20">B.com</h3>
                                    <p className="text-body-excerpt mt-20">B.com is an excellent choice for students interested in pursuing a career in the field of information technology (IT) and computer science</p>
                                    <div className="mt-30">
                            ...
                            <div className="col-lg-4 col-sm-12">
                                <div className="card-grid-style-3 bd-bg-6 pb-40 mb-30">
                                    ...
                                    <h3 className="text-heading-3 mt-20">BCA</h3>
                                    <p className="text-body-excerpt mt-20">BCA is an excellent choice for students interested in pursuing a career in the field of information technology (IT) and computer science</p>
                                    <div className="mt-30">
                                        <Link href="/page-service-1" legacyBehavior><a className="btn btn-default icon-arrow-right">Learn more
                                        </a></Link>
                                    </div>
                            ...
                            <div className="col-lg-4 col-sm-12">
                                <div className="card-grid-style-3 bg-2 pb-40 mb-30">
                                    ...
                                    <h3 className="text-heading-3 mt-20">BBA</h3>
                                    <p className="text-body-excerpt mt-20">BBA is an excellent choice for students interested in pursuing a career in the field of information technology (IT) and computer science</p>
                                    <div className="mt-30">
                                        <Link href="/page-service-1" legacyBehavior><a className="btn btn-default icon-arrow-right">Learn more
                                        </a></Link>
                                    </div>
