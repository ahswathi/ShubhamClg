            ...
            <section className="section-box">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-lg-12 text-center">
                                        <h1 className="text-display-3 color-white mb-30">Transforming education, preparing for a changing world.</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="banner-hero bg-about-3">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12 text-center">
                                    <h1 className="text-display-2 color-gray-900">B.com</h1>
                                    <p className="text-heading-4 color-gray-600 mt-40">This is a three-year integrated degree programme of six semesters. It comprises 21 papers including study of two languages initiates the students into higher accounting principles, management & allied disciplines. Computer Application paper is new addition introduced as mandatory for study in all three years of B.Com Course.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="container mt-120">
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-sm-12 block-img-we-do">
                                    <div className="inner-image pt-100">
                                        <img className="bdrd-16 img-responsive" src="assets/image-03.png" alt="Agon" />
