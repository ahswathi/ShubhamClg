        ...
        <>
            <footer className="footer mt-50">
                <div className="container">
                    ...
                    <div className="row">
                    <div className="col-lg-4 width-50 mb-30">
                            <h4 className="text-heading-5">About Us</h4>
                            <div className="mt-20 text-body-text color-gray-600 mb-20">Welcome to our degree college! <br/>
                            We are committed to providing <br/>a comprehensive and high-quality <br/>education to our students.
                             </div>
                           
                        </div>
                        <div className="col-lg-4 width-40 mb-30">
                            <h4 className="text-heading-5">Contact</h4>
                            <div className="mt-20 text-body-text color-gray-600 mb-20">4517 Washington Ave.<br/> Manchester, Kentucky 39495 
                             </div>
                       ...
                       {/*  <div className="col-lg-3 width-20 mb-30">
                        ...
                        <div className="col-lg-4 width-30">
                            <h4 className="text-heading-5">Useful links</h4>
                            <ul className="menu-footer mt-20">
                                
                                <li>
                                    <Link href="/bcom" legacyBehavior>
                                        <a>B.com</a>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/bca" legacyBehavior>
                                        <a>BCA</a>
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/bba" legacyBehavior>
                                        <a>BBA</a>
                                    </Link>
                                </li>
                                <li>
                    ...
                    <div className="footer-bottom mt-20">
                        <div className="row">
                            ...
                            <Link href="https://www.thirdeyeinfo.com/" legacyBehavior>
                                        <a className="color-gray-400 text-body-lead">© Thireye Innovations Pvt Ltd.</a>
                                    </Link>
