                            ...
                            <div className="header-nav">
                                <nav className="nav-main-menu d-none d-xl-block">
                                    <ul className="main-menu">
                                        ...
                                        <li className="has-children">
                                            <Link href="#" legacyBehavior><a>Courses</a></Link>
                                            <ul className="sub-menu">
                                                <li>
                                                    <Link href="/bcom" legacyBehavior><a>{/* <i className="fi fi-rr-paper-plane" /> */}B.Com</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/bca" legacyBehavior><a>{/* <i className="fi fi-rr-user-add" /> */}BCA</a></Link>
                                                </li>
                                                <li>
                                                    <Link href="/bba" legacyBehavior><a>{/* <i className="fi fi-rr-fingerprint" /> */}BBA</a></Link>
                                                </li>
                                               {/*  <li>
                                        ...
                                        {/* <li className="has-children">
                                            ...
                                            <ul className="sub-menu">
                                                <li>
                                                    <Link href="/gallery" legacyBehavior><a className="closer"><i className="fi fi-rr-edit" />Gallery</a></Link>
                                                </li>
                                                <li>
